...
export default function CodringtonAve() {
  ...
  return (
    <div className="bg-[#140D0C]">
      <Head>
        <title>240 Codrington Ave | Hurricane-Resistant Architecture in Florida</title>
        <meta name="description" content="Discover the 240 Codrington Ave Build by RK Architect, PA & RK Builders, featuring hurricane-resistant construction and structural integrity." />
      </Head>
      ...
      <div className="relative isolate px-6 pt-20 lg:px-8">
        ...
        <div className="py-10 sm:py-20 lg:py-20 flex justify-center items-center" data-aos="fade-up">
          <div className="text-center">
            ...
            <img src="/240house.jpg" alt="240 Codrington Ave Build - architecture, architect, disaster resistant homes" className="w-full max-w-2xl mx-auto h-auto rounded-lg border-2 border-[#936F27] shadow-lg shadow-black mb-8 mt-10" />
                ...
                >
                  {imageUrls.map((url, index) => (
                    <img
                      key={index}
                      src={url}
                      alt={`Codrington Ave Image ${index + 1} - architecture, architect, safety inspections, disaster resistant homes`}
