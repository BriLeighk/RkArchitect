        ...
        <div className="py-10 sm:py-20 lg:py-20 flex justify-center items-center" data-aos="fade-up">
          <div className="text-center">
            ...
            <Image
              ...
              alt="Multifamily inspection and repair project by RK Architect, P.A."
              width={1200}
              height={800}
                  ...
                  <div className="grid grid-cols-4 gap-4 items-center">
                    {imageUrls.slice(0, 4).map((url, index) => (
                      <Image
                        key={url}
                        src={url}
                        alt={`Multifamily inspection project photo ${index + 1} by RK Architect, P.A.`}
                        width={1200}
                        height={900}
                  ...
                  <div className="grid grid-cols-3 gap-4 items-center mt-4">
                    {imageUrls.slice(4).map((url, index) => (
                      <Image
                        key={url}
                        src={url}
                        alt={`Multifamily inspection project photo ${index + 5} by RK Architect, P.A.`}
                        width={1200}
                        height={900}
