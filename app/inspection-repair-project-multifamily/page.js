      ...
      <div className="relative isolate px-6 pt-20 lg:px-8">
        ...
        <div className="py-10 sm:py-20 lg:py-20 flex justify-center items-center" data-aos="fade-up">
          <div className="text-center">
            ...
            <img src="/InspectionAndRepairMF.jpg" alt="Inspection and Repair - architecture, architect, multifamily building due-diligence inspections" className="w-full max-w-2xl mx-auto h-auto rounded-lg border-2 border-[#936F27] shadow-lg shadow-black mb-8 mt-10" />
                  ...
                  <div className="grid grid-cols-4 gap-4 items-center">
                    {imageUrls.slice(0, 4).map((url, index) => (
                      <img
                        key={index}
                        src={url}
                        alt={`Multifamily Building Image ${index + 1} - architecture, architect, safety inspections`}
                  ...
                  <div className="grid grid-cols-3 gap-4 items-center mt-4">
                    {imageUrls.slice(4).map((url, index) => (
                      <img
                        key={index + 4}
                        src={url}
                        alt={`Multifamily Building Image ${index + 5} - architecture, architect, 40-50 year building safety inspections`}
                        className="h-auto rounded-lg hover:scale-105 transition-all duration-300 hover:opacity-60 cursor-pointer"
                        onClick={() => {
