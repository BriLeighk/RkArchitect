      ...
      <div className="relative isolate px-6 pt-20 lg:px-8">
        ...
        <div className="py-10 sm:py-20 lg:py-20 flex justify-center items-center" data-aos="fade-up">
          <div className="text-center">
            ...
            <Image
              src="/1130home.jpg"
              alt="1130 hurricane-resistant custom home by RK Architect, P.A. and RK Builders"
              width={1200}
              height={800}
                ...
                >
                  {imageUrls.map((url, index) => (
                    <Image
                      key={url}
                      src={url}
                      alt={`1130 hurricane-resistant home project photo ${index + 1} by RK Architect, P.A.`}
                      width={1200}
                      height={900}
