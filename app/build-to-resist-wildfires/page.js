...
export default function BuildToResistsWildfires() {
  return (
    <div className="text-gray-300 bg-[#1E1412]">
      <Header />
        ...
        <div className="mt-24 lg:mt-32 mb-10  flex justify-center items-center" data-aos="fade-up">
          <div className="text-center">
            <h1 className="text-4xl font-bold tracking-tight sm:text-5xl" style={{ color: '#F2F4E6' }}>
              Can We Build to Resist Extreme <br /> Wildfires & Fire Tornadoes?
            </h1>
          </div>
        </div>
        ...
        <div className="space-y-6">
          ...
          <p>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-8 items-center">
                <div className="relative w-full max-w-4xl h-0 pb-[56.25%] mx-auto rounded-lg border-2 border-[#936F27] shadow-lg shadow-black">
                  <iframe 
          ...
          <img src="/FireSameHomeBuild.jpg" alt="Fire Safe Home Build" className="w-full max-w-2xl mx-auto h-auto rounded-lg border-2 border-[#936F27] shadow-lg shadow-black mb-8" />
