...
export default function CourtyardHome() {
  ...
  useEffect(() => {
    const fetchImages = async () => {
      const storageRef = ref(storage, '42-ne-miami');
          ...
          <div className="py-10 sm:py-20 lg:py-20 flex justify-center items-center" data-aos="fade-up">
            <div className="text-center">
              ...
              <Image
                ...
                alt="NE Miami renovation home by RK Architect, P.A. and RK Builders"
                width={1200}
                height={800}
              ...
              <div className=" mx-auto max-w-3xl grid grid-row-2 justify-center items-center">
                <h4 className=" text-lg mt-10 text-white">
                  <span className="text-[#8E784D]">✦</span> As the architect and builder for this custom renovation home, I embraced the challenge of transforming the client's vision into reality. The project demanded meticulous attention to detail and innovative solutions to create a space that is both functional and aesthetically pleasing.
                </h4>
                  ...
                  >
                    {imageUrls.map((url, index) => (
                      <Image
                        key={url}
                        src={url}
                        alt={`NE Miami renovation project photo ${index + 1} by RK Architect, P.A.`}
                        width={1200}
                        height={900}
